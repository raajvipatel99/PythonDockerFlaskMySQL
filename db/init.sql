...
CREATE TABLE IF NOT EXISTS tblCitiesImport (
    ...
    `fldLat` NUMERIC(25, 4),
    `fldLong` NUMERIC(25, 4),
    `fldCountry` VARCHAR(25) CHARACTER SET utf8,
    `fldAbbreviation` VARCHAR(10) CHARACTER SET utf8,
    `fldCapitalStatus` VARCHAR(25) CHARACTER SET utf8,
    `fldPopulation` INT,
    PRIMARY KEY (`id`)
);
